    ...
    return (
      <div className="w-full">
        ...
        <div className="relative group">
          ...
          />
          {suffix && (
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-300 text-sm font-medium bg-slate-100 dark:!bg-slate-700 px-2 py-1 rounded-lg border border-slate-200/50 dark:border-slate-600/50">
              {suffix}
            </span>
          )}
        </div>
