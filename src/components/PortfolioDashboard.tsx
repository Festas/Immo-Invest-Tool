      ...
      {properties.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-500">Noch keine Immobilien gespeichert.</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <p className="text-gray-500">Gesamt-Eigenkapital</p>
                <p className="font-bold text-lg">{formatCurrency(summary.totalEquity)}</p>
              </div>
              <div>
                <p className="text-gray-500">Gesamt-Schulden</p>
                <p className="font-bold text-lg">{formatCurrency(summary.totalDebt)}</p>
              </div>
              <div>
                <p className="text-gray-500">Jährlicher Cashflow</p>
                <p
                  className={`font-bold text-lg ${
                    summary.totalAnnualCashflow >= 0 ? "text-green-600" : "text-red-600"
                  }`}
                >
              ...
              <div>
                <p className="text-gray-500">Eigenkapitalquote</p>
