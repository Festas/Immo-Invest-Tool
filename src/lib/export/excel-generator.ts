...
function generateSideCostsSheet(data: ExcelExportData): SheetData {
  ...
  return {
    ...
    rows: [
      ...
      ['Grunderwerbsteuer', input.propertyTransferTaxPercent, output.investmentVolume.sideCosts.propertyTransferTax],
      ['Renovierungskosten', 0, output.investmentVolume.sideCosts.renovationCosts],
      ['Gesamt', output.investmentVolume.sideCosts.totalSideCostsPercent, output.investmentVolume.sideCosts.totalSideCosts],
    ],
  };
}
