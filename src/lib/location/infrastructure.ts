...
export function analyzeInfrastructure(
  ...
  const categories: InfrastructureCategory[] = [
    {
      category: "ÖPNV & Verkehr",
      score: transport.score,
      details: transport.details.map((d) => ({ name: d, distance: 0, quality: "GOOD" as const })),
    },
    {
      category: "Einkaufen",
      score: shopping.score,
      details: shopping.details.map((d) => ({ name: d, distance: 0, quality: "GOOD" as const })),
    },
    {
      category: "Bildung",
      score: education.score,
      details: education.details.map((d) => ({ name: d, distance: 0, quality: "GOOD" as const })),
    },
    {
      category: "Gesundheit",
      score: healthcare.score,
      details: healthcare.details.map((d) => ({ name: d, distance: 0, quality: "GOOD" as const })),
    },
    {
      category: "Freizeit",
      score: recreation.score,
      details: recreation.details.map((d) => ({ name: d, distance: 0, quality: "GOOD" as const })),
    },
  ];
